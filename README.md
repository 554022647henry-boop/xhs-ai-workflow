...
> 一套即插即用的小红书账号 AI 运营系统。你只负责**决策和核心观点**——选哪个题、这篇想说什么、稿子改哪里；其余的调研、起草、配图、发布，全部由 AI 完成。
...
| 环节 | 你负责 | AI 负责 |
|------|--------|--------|
| 选题 | 从候选中拍板 | 搜热度、去重、提建议 |
| 调研 | 决定要不要看参考 | 搜高赞内容、整理报告 |
| 写稿 | 提供核心观点和真实经历 | 按你的风格起草、打磨 |
| 审稿 | 决定改不改 | 对比爆款、给具体建议 |
| 发布 | 最终确认 | 配标签、生成图片、一键发布 |
| 选题库 | 确认加不加 | 每周扫描热门内容、提取新选题 |
...
第一次启动时，AI 会引导你完成账号配置，无需手动编辑文件。

也可以提前直接修改 `项目主旨.md`、`写作风格指南.md`、`选题库.md` 这 3 个文件。
...
完全可以。跳过「自动发布配置」，只需完成账号配置，把 `主控Prompt.md` 提供给任意 AI 即可开始协作写稿。

**Q：AI 会自己做所有决定吗？**
不会。选题、核心观点、定稿都由你决定，AI 在每个关键节点都会暂停等你确认，不会跳过。
